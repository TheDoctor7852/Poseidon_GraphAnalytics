...
namespace analytics{
    ...
    */
    void dfs_recursive (graph_db_ptr& graph, node::id_t start, utils::PropertyTracker<bool>& found, std::vector<relationship*>& partial_vec);
    ...
    /*
        ...
        Rückgabe ist hierbei ein Vector der alle durchlaufenen Kanten enthält, welche sich hierbei im partial_vec befinden.
    */
    void dfs_recursive (graph_db_ptr& graph, node::id_t start, utils::PropertyTracker<bool>& found, std::vector<relationship*>& partial_vec,std::vector<node::id_t>& end, bool& found_endnode);
